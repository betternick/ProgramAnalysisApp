...
public class ThreeTypeOfStaticErrors {
    ...
    public static void main(String[] args) {
        ...
        int a = 5;
        int b = 10;
        // Type 1: The following variable is declared but never used.
        int c;

        if (a > b) {
            // Type 2: The following variable is declared a second time.
            int a = 67;
            // Type 3: The following variable is assigned a value before declaration.
            d = 57;
            String gh = "fgghgh";
            calculateSum(a, b);
